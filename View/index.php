            ...
            <div class="bdlist">
                <div class="lbd">
                    ...
                    <ul class="filmcontainer">
                        ...
                        <!-- <li class="filmcontent">
                            <a href="#">
                                <i class="fa-sharp fa-solid fa-play"></i><img src="./assets/image/body/139539.jpg" alt="">
                        ...
                        <li class="filmcontent">
                            <a href="#">
                                <i class="fa-sharp fa-solid fa-play"></i><img src="./assets/image/body/140224.jpg" alt="">
                                <h2>Lorem ipsum</h2>
                                <div>
                                    <h3>Lượt xem: 999.999.999</h3>
                                </div>
                        ...
                        <li class="filmcontent">
                            <a href="#">
                                <i class="fa-sharp fa-solid fa-play"></i><img src="./assets/image/body/animevsub-0PY6DPdY7W.jpg"
                                    alt="">
                                <h2>Lorem ipsum</h2>
                                <div>
                                    <h3>Lượt xem: 999.999.999</h3>
                        ...
                        <li class="filmcontent">
                            <a href="#">
                                <i class="fa-sharp fa-solid fa-play"></i><img src="./assets/image/body/animevsub-0SyyBVHJLI.webp"
                                    alt="">
                        ...
                        <li class="filmcontent">
                            <a href="#">
                                <i class="fa-sharp fa-solid fa-play"></i><img src="./assets/image/body/animevsub-8CW3l6FGUR.jpg"
                                    alt="">
                        ...
                        <li class="filmcontent">
                            <a href="#">
                                <i class="fa-sharp fa-solid fa-play"></i><img src="./assets/image/body/animevsub-4c3AEMjYfT.webp"
                                    alt="">
                                <h2>Lorem ipsum dolor sit amet</h2>
                                <div>
                                    <h3>Lượt xem: 999.999.999</h3>
                        ...
                        <li class="filmcontent">
                            <a href="#">
                                <i class="fa-sharp fa-solid fa-play"></i><img src="./assets/image/body/animevsub-atiCXNS4vO.jpg"
                                    alt="">
                                <h2>Lorem ipsum dolor sit amet.</h2>
                                <div>
                                    <h3>Lượt xem: 999.999.999</h3>
                        ...
                        <li class="filmcontent">
                            <a href="#">
                                <i class="fa-sharp fa-solid fa-play"></i><img src="./assets/image/body/animevsub-bakcDrPuF4.jpg"
                                    alt="">
                                <h2>Lorem ipsum</h2>
                                <div>
                                    <h3>Lượt xem: 999.999.999</h3>
                        ...
                        <li class="filmcontent">
                            <a href="#">
                                <i class="fa-sharp fa-solid fa-play"></i><img src="./assets/image/body/animevsub-CLgSVIagmk.webp"
                                    alt="">
                                <h2>Lorem ipsum dolor</h2>
                                <div>
                                    <h3>Lượt xem: 999.999.999</h3>
